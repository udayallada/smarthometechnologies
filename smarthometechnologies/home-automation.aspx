...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div <%--style="background: linear-gradient(to bottom, #EDF1F2, #D5E2F2);"--%>>
        <div class="container mt-5 mb-5">
            <div class="row">   
                <div class="col-md-7 order-md-2 order-sm-1">
...
<div class="container mt-5 mb-5">
 ...
 <div style="background: linear-gradient(to bottom, #EDF1F2, #D5E2F2);">
     <section id="service">
         <div class="container">
             <h2 class="mainlock_h1 pb-4">Home Automation Solutions</h2>
             <p>Elevate your living experience with Home Automation services from Wee Aesthetics. Our home automation solutions integrate technology into your home to enhance convenience, comfort, and energy efficiency. Whether you’re looking to control your lights, security, or climate from your smartphone, our team provides smart solutions for every aspect of your home. We offer customized automation systems designed to make your life easier, safer, and more enjoyable. 
                 <br />
                 Our range of Home Theater services includes:</p>
             <br />
             <div class="row">
                 <%-- 1 --%>
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/lighting.png" width="40" style="color: darkblue" />
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Smart Lighting Systems</h4>
                             <p>Create the perfect ambience for every occasion with smart lighting that adjusts automatically based on your schedule or preference. From dimming lights for movie nights to brightening the room for work, we provide seamless control over your home's lighting.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/cctv-camera.png" width="40" />
                            
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Home Security & Surveillance Systems</h4>
                             <p> Enhance your home’s security with state-of-the-art smart cameras, motion detectors, and doorbell cameras. Monitor your property in real-time through your smartphone, ensuring peace of mind when you’re at home or away.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         ...
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Climate Control (Smart Thermostats & HVAC Integration)</h4>
                             <p> Maintain the perfect temperature year-round with smart thermostats that learn your preferences and adjust automatically. We integrate HVAC systems for energy-efficient temperature control, saving you money while keeping your home comfortable.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/voice-assistant.png" width="40" />
                             
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Voice-Controlled Home Automation</h4>
                             <p> Control your entire home with just your voice. Our integration of voice assistants like Amazon Alexa or Google Assistant allows you to manage lighting, security, climate, and entertainment systems hands-free.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/smart-blind.png" width="40" />
                             
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Automated Blinds & Shades</h4>
                             <p>Enjoy the convenience of motorized blinds that can be controlled remotely or set to open and close at specific times of the day. Our automated shading systems help regulate natural light and enhance privacy.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         ...
                         <div class="icon mb-4">
                             <img src="icons/home-automation/integrated.png" width="40" />
                             
                         </div>

                         <div class="single_service-body">
                             <h4 class="single_service-heading">Smart Home Integration</h4>
                             <p> With a unified home automation system, control everything — from lights and security systems to appliances — using a single app or central hub. We integrate all your smart devices for a seamless and intuitive experience.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         ...
                         <div class="icon mb-4">
                             <img src="icons/home-automation/audio-video.png" width="40" />
                         </div>

                         <div class="single_service-body">
                             <h4 class="single_service-heading">Audio & Video Distribution Systems</h4>
                             <p> Enjoy synchronized audio and video throughout your home. Whether it's for music streaming or watching movies, our distribution systems ensure high-quality sound and visuals in every room.
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         ...
                         <div class="icon mb-4">
                             <img src="icons/home-automation/home-appliances.png" width="40" />
                         </div>

                         <div class="single_service-body">
                             <h4 class="single_service-heading">Smart Appliances</h4>
                             <p> Smart appliances, such as refrigerators, ovens, washing machines, and robotic vacuums, can make your home more efficient. You can also control and monitor your appliances remotely for added convenience.
                             </p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/local-network.png" width="40" />                             
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Home Networking & Wi-Fi Solutions</h4>
                             <p> Stay connected with fast and reliable internet by installing high-performance Wi-Fi systems, including mesh networks that provide strong signals across all areas of your home.
                             </p>
                         </div>
                     </div>
                 </div>
                 <div class="col-md-6 col-lg-4 col-sm-12">
                     <div class="single_service hvr-curl-top-right">
                         <div class="icon mb-4">
                             <img src="icons/home-automation/irrigation.png" width="40" />                             
                         </div>
                         <div class="single_service-body">
                             <h4 class="single_service-heading">Automated Irrigation & Gardening Systems</h4>
                             <p> Maintain a beautiful garden with minimal effort. We install smart irrigation systems that adjust watering schedules based on weather forecasts and soil moisture, helping you save water while keeping your plants healthy.
                             </p>
                         </div>
                     </div>
                 </div>
