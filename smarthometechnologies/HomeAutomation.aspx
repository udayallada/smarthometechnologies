            ...
            <div class="row">
                <div class="col-md-6 bg-white">
                    <div class="card-content">
                        ...
                        <p><a href="SmartLocks.aspx" target="_blank" class="btn btn--with-icon mt-3"><i class="btn-icon fas fa-long-arrow-alt-right"></i>READ MORE</a></p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 bg-white">
                    <div class="card-content">
                        ...
                        <p><a href="SmartLocks.aspx" target="_blank" class="btn btn--with-icon mt-2"><i class="btn-icon fas fa-long-arrow-alt-right"></i>READ MORE</a></p>
                    </div>
                </div>
                <div class="col-md-7 p-0">
